            ...
            <div class="col-md-6 offset-md-3">
                ...
                <form>
                    <div class="mb-3">
                        ...
                        <input type="email" class="form-control" id="email" name="email" required placeholder="Username">
                    </div>
                    <div class="mb-3">
                    ...
                    <button type="submit" class="btn btn-primary btn-bg">Capture Fingerprint</button>
